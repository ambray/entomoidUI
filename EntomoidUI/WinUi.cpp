...
bool entomoid::WindowBase::init(HINSTANCE hinst)
{
	WNDCLASSEXA wc = { 0 };
	...
	try {
		...
		if (nullptr == (window_ = CreateWindowEx(0, className.c_str(), "Title.", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, nullptr, nullptr, hinst, nullptr))) {
