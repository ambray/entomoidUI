...
if "%1"=="android" (
    call cmake.exe -DCMAKE_TOOLCHAIN_FILE=".\build\android.toolchain.cmake" -DANDROID_NDK=%HOMEPATH%\android-ndk-r10e -DANDROID_ABI="x86" -DCMAKE_BUILD_TYPE=Debug -GNinja
